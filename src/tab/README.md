...
| Property                                       | Description                              |
|------------------------------------------------|------------------------------------------|
| `--omni-tab-bar-height`                        | Tab group tab bar height.                |
...
| `--omni-tab-group-tab-indicator-border-radius` | .                                        |
| `--omni-tab-group-tab-indicator-color`         | .                                        |
| `--omni-tab-group-tab-indicator-height`        | Tab group selected tab indicator height. |
...
| `--omni-theme-primary-color`                   | Theme primary color.                     |
| `--omni-theme-primary-hover-color`             | Theme primary hover color.               |
| `--theme-tab-selected-font-color`              | Tab group selected Tab font color.       |
