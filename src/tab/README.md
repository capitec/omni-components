...
| `--omni-tab-header-group-tab-indicator-border-radius` | Tab group active tab indicator border radius. |
| `--omni-tab-header-group-tab-indicator-color`    | Tab group active tab indicator color.         |
| `--omni-tab-header-group-tab-indicator-height`   | Tab group active tab indicator height.        |
| `--omni-tab-header-group-tab-indicator-width`    | Tab group active tab indicator width.         |
| `--omni-tab-header-group-tab-selected-font-color` | Tab group active tab label font color.        |
| `--omni-tab-header-height`                       | Tab header tab height.                        |
| `--omni-tab-header-hover-background-color`       | Tab group tab hover background.               |
...
| `--omni-tab-header-tab-label-container-height`   | Tab group tab label container height.         |
| `--omni-tab-header-tab-tab-indicator-height`     | Tab group tab active indicator height.        |
| `--omni-theme-accent-active-color`               | Theme accent active color.                    |
| `--omni-theme-accent-color`                      | Theme accent color.                           |
| `--omni-theme-accent-hover-color`                | Theme accent hover color.                     |
| `--omni-theme-background-active-color`           | Theme background active color.                |
