...
| `--omni-numeric-field-minus-line-height`         | Numeric input stepper minus icon line height.    |
| `--omni-numeric-field-plus-line-height`          | Numeric input stepper plus icon line height.     |
| `--omni-numeric-field-plus-minus-sign-font-size` | Numeric input plus and minus sign font size.     |
| `--omni-numeric-field-plus-minus-sign-height`    | Numeric input plus and minus sign height.        |
| `--omni-numeric-field-plus-minus-sign-padding-top` | Numeric input plus and minus top padding.        |
| `--omni-numeric-input-divider-height`            | Numeric input divider height.                    |
| `--omni-numeric-input-divider-margin-top`        | Numeric input divider top margin.                |
| `--omni-numeric-input-divider-width`             | Numeric input divider width.                     |
| `--omni-numeric-input-plus-minus-focussed-color` | Numeric input plus and minus icon focussed color. |
| `--omni-numeric-input-plus-minus-focussed-hover` | Numeric input plus and minus focussed hover.     |
| `--omni-numeric-input-quantity-right`            | Numeric input quantity div right.                |
| `--omni-numeric-input-quantity-top`              | Numeric input quantity div top.                  |
