 ...
 * ```
 *
 * @element omni-loading-icon
 *
 */
@customElement('omni-loading-icon')
export class LoadingIcon extends OmniElement {
        ...
        return [
            ...
            css`
                :host {
                    ...
                    fill: var(--omni-theme-primary-color);
