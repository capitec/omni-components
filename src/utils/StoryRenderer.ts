            ...
            <div class="two-part ${
                ...
                <omni-button 
                    ...
                    <omni-icon size="default">
                        <svg class="hidden-after-760" style="height: 22px;" viewBox="0 0 138 26" fill="none" stroke="var(--omni-button-secondary-hover-border-color, currentColor)" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" width="100%" height="100%" title="CodePen">
