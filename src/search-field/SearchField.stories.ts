...
export const Interactive = {
    ...
    args: {
        ...
        error: '',
        disabled: false,
        prefix:  raw`<div style="padding-left: 15px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px"><path d="M8.5.25a8.25 8.25 0 0 1 6.34 13.529l7.683 7.684a.75.75 0 0 1-.976 1.133l-.084-.073-7.684-7.683A8.25 8.25 0 1 1 8.5.25Zm0 1.5a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5Z"/></svg></div>`,
        suffix: ''
    },
